<template>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <div class="row">
                    <div class="col-6 col-md-3" v-for="(card, index) in jeu.cards" :key="index">
                        <img  style="max-width: 100%" :src="card.image_uris.normal"  alt="">
    ...
    <button class="btn btn-danger" @click="$store.dispatch('delete_jeu')">Supprimer le jeu actuel</button>
</div>
</template>
